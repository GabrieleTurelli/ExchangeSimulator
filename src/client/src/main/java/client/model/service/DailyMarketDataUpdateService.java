...
public class DailyMarketDataUpdateService extends BaseUpdateService<DailyMarketData> {

    private final String coin;

    public DailyMarketDataUpdateService(String coin, Duration updateInterval) {
