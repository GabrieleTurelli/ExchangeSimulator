...
public class Theme {
    ...
    public static class COLOR {
        ...
        public static final Color BACKGROUND = Color.web("#121212");      // Background color
        public static final Color SURFACE = Color.web("#282828");         // Surface color
    ...
    public static class HEX_COLOR {
        ...
        public static final String BACKGROUND = "#121212";      // Background color
        public static final String SURFACE = "#282828";         // Surface color
