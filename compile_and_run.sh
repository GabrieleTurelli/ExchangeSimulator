...
# Compile
javac -d out -cp .:lib/openjfx-23.0.1_linux-x64_bin-sdk/javafx-sdk-23.0.1/lib/* src/gui/*.java  src/gui/components/*.java src/gui/utils/*.java src/gui/theme/*.java src/Main.java
